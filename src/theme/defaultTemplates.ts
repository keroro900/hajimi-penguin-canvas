...
const farmStoryLight: ThemeTokens = {
  appBg: '#cfeaa2',
  canvasBg: '#d8efb0',
  panelBg: '#fff7df',
  panelBgElevated: '#fffdf2',
  panelBgMuted: '#ead8aa',
  nodeBg: '#fffdf2',
  nodeHeaderBg: '#f4c95d',
  textMain: '#2b1a0e',
  ...
  danger: '#bf4d3b',
  success: '#4f9d69',
  shadowPanel: '0 18px 44px rgba(76,49,20,0.18), 4px 4px 0 #8a5a2b',
  shadowButton: '3px 3px 0 #8a5a2b',
  shadowStrong: '0 28px 72px rgba(76,49,20,0.24), 6px 6px 0 #5b3518',
  radiusPanel: '10px',
  radiusButton: '8px',
  radiusNode: '8px',
  gridDot: '#9fc879',
  edge: '#8a5a2b',
  edgeSelected: '#f4c95d',
  selectionBg: 'rgba(111,191,74,0.18)',
  selectionBorder: '#d08b3e',
  portText: '#4aa3d8',
  portImage: '#f4c95d',
  portVideo: '#c8553d',
  portAudio: '#9b6bd3',
...
const farmStoryDark: ThemeTokens = {
  ...farmStoryLight,
  appBg: '#102717',
  canvasBg: '#17351f',
  panelBg: '#25311f',
  panelBgElevated: '#2f3f27',
  panelBgMuted: '#1b2819',
  nodeBg: '#2f3a25',
  nodeHeaderBg: '#6d4a22',
  textMain: '#fff5d6',
  ...
  danger: '#ff7667',
  success: '#8fe39a',
  shadowPanel: '0 18px 52px rgba(0,0,0,0.5), 4px 4px 0 #09160c',
  shadowButton: '3px 3px 0 #09160c',
  shadowStrong: '0 28px 82px rgba(0,0,0,0.68), 6px 6px 0 #09160c',
  gridDot: '#436738',
  edge: '#d9a15f',
  edgeSelected: '#f5d36a',
  selectionBg: 'rgba(155,214,111,0.18)',
  selectionBorder: '#f5d36a',
  portText: '#7fd4ff',
  portImage: '#f5d36a',
  portVideo: '#ff7667',
  portAudio: '#c7a5ff',
...
export const BUILT_IN_THEME_TEMPLATES: ThemeTemplate[] = [
  ...
  },
  {
    schema: 't8-theme-template',
    version: THEME_TEMPLATE_VERSION,
    id: FARM_STORY_TEMPLATE_ID,
    name: '牧场物语主题',
    description: 'Farm Story Canvas：草地地图、木牌节点、农具控制轨、牧场 HUD 和全画布养成游戏层入口。',
    author: 'T8',
    builtIn: true,
    legacyStyle: 'pixel',
    visuals: {
    ...
    modes: { dark: { tokens: farmStoryDark }, light: { tokens: farmStoryLight } },
  },
  {
    schema: 't8-theme-template',
    version: THEME_TEMPLATE_VERSION,
