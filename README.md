...
- 🧪 **Grok Image / Sora2 FAL / Grok Video FAL**：图像节点新增 Grok Image TAB；视频节点新增 Sora2 FAL，并把 Grok Video FAL 扩展为图生视频 / 参考生视频两种模式，Grok Video FAL 默认参考生视频，参考图默认 base64 传入；GPT2 图像参考图上限提升到 9 张
